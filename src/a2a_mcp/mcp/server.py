...
def serve(host, port, transport):  # noqa: PLR0915
    ...
    def find_agent(query: str) -> str:
        ...
        if df is None or df.empty:
            logger.error('No agent card embeddings available. Server initialization may have failed.')
            return json.dumps({'error': 'No agent cards available. Embeddings failed to generate.'})
        ...
        try:
            ...
            logger.error(f'Error in find_agent: {e}', exc_info=True)
