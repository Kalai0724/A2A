...
DEFAULT_HOTEL_IMAGE = "https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=800&q=80"
...
async def handle(request: web.Request):
    ...
    try:
        ...
        _dlog("Raw response sample:", json.dumps(offers_data.get("data", [{}])[0], indent=2)[:500])
        ...
        if len(hotels) < MAX_HOTELS and time.monotonic() < (deadline - 5.0):
            ...
            for hid in remaining_ids:
                ...
                try:
                    ...
                    # Ignore individual hotel errors and continue.
                    _dlog(f"Per-hotel offers failed for {hid}")
                    continue
