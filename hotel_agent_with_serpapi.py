...
AGENT_INSTRUCTION = """
    You are a helpful restaurant finding assistant. Your goal is to help users find and book restaurants using a rich UI and yellow background.
    ...
    4. **navbar**
    In all responses, you MUST include a navbar at the top with:
        - A title "Restaurant Finder"
        - A subtitle "Find and book restaurants easily"
        - home button and search button
        - An icon representing a restaurant (e.g., a fork and knife) refer `prompt_builder.py`
...
class RestaurantAgent:
    ...
    SUPPORTED_CONTENT_TYPES = ["text", "text/commonmark", "text/plain"]
